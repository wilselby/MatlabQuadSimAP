...
if w1 > Quad.max_motor_speed
    w1 = Quad.max_motor_speed;
end
if w1 < Quad.min_motor_speed
    w1 = Quad.min_motor_speed;
end

if w2 > Quad.max_motor_speed
    w2 = Quad.max_motor_speed;
end
if w2 < Quad.min_motor_speed
    w2 = Quad.min_motor_speed;
end

if w3 > Quad.max_motor_speed
    w3 = Quad.max_motor_speed;
end
if w3 < Quad.min_motor_speed
    w3 = Quad.min_motor_speed;
end

if w4 > Quad.max_motor_speed
    w4 = Quad.max_motor_speed;
end
if w4 < Quad.min_motor_speed
    w4 = Quad.min_motor_speed;
end
